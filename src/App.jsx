...
const App = () => {
  ...
  const styles = {
    app: { minHeight: '100vh', fontFamily: '"Franklin Gothic Demi", "Franklin Gothic Medium", "Arial Black", sans-serif', color: currentTheme.text, transition: 'all 0.3s ease', position: 'relative' },
    ...
    serviceTitle: { fontSize: '24px', fontWeight: 'bold', marginBottom: '15px', color: currentTheme.text },
    ...
    statNumber: { fontSize: '32px', fontWeight: 'bold', color: currentTheme.text, marginBottom: '5px' },
    ...
    heroH1: { fontSize: isMobile ? '36px' : '48px', fontWeight: 'bold', marginBottom: '20px', lineHeight: 1.2 },
    ...
    classCard: { textAlign: 'center', background: `${currentTheme.bg}E6`, backdropFilter: 'blur(10px)', borderRadius: '20px', border: isDarkTheme ? `1px solid ${currentTheme.border}` : 'none', padding: '20px', cursor: 'pointer', transition: 'all 0.3s ease' },
    ...
    classImage: { aspectRatio: '4/3', background: currentTheme.cardBg, border: isDarkTheme ? `1px solid ${currentTheme.border}` : 'none', marginBottom: '20px', borderRadius: '16px', width: '100%' },
    h2: { fontSize: '32px', fontWeight: 'bold', textAlign: 'center' },
